...
|
 Data Source 
|
 Availability and Accessibility Info/Latest Rounds 
|
 Limitations 
|
|
...
|
**
Association of State and Territorial Health Officials (ASTHO) Profile Survey
**
|
...
. Data briefs, survey questionnaires, etc., are publicly available. Data dashboards are available 
[
here
](
here
)
. Profile surveys conducted in 2007, 2010, 2012, 2016, and 2019. 
|
 Data reported directly by state and territorial health agencies and not verified with external sources. 
|
|
**
...
**
|
 Data is not publicly available but available upon request. All profile study reports are publicly available. 9 profile studies have been conducted so far, with the most recent in 2019. 
|
 Survey population limited to workers. Incomplete list of occupations due to missing data. Contract workers not distinguished from health department employees. Occupational classifications may lead to miscounting. Not all local health departments participate. Uncertainty about the next profile study. 
|
|
**
Office of Personnel Management (OPM) Federal Employment Statistics
**
|
 All raw datasets up to 2021 are publicly available 
[
here
](
here
...
. 
|
 Occupational classifications of workers may not reflect their job functions accurately. Statistics exclude U.S. Public Health Service and other non-civilian federal public health workers. Federal contractors are not included. 
|
|
**
Centers for Disease Control and Prevention (CDC) Personnel Data
**
|
 No publicly available dataset on personnel found. 
|
 Classification based on job title, not public health function. Job classifications do not easily correspond to previous enumeration efforts. Accessing data is difficult as it's not publicly available. 
|
|
**
Bureau of Labor Statistics (BLS) Occupational Employment Statistics and Current Population Survey Data
**
|
...
. Monthly surveys with the most recent Employment Situation Report scheduled for August 2022. 
|
 Specific to a limited number of public health workers (SOCs). NAICS needs 5-digit codes to identify government agencies. Data may lead to overcounting public health workers. 
|
|
**
...
**
|
 2016-2020 ACS 5-year data products are available on 
[
data.census.gov
](
...
|
 Industry codes and occupational classifications not detailed enough for public health workers. Survey captures occupation but not job function. Possible bias in collected data. 
|
|
**
Association of Public Health Laboratories (APHL) National Laboratory Workforce Capacity Assessment Data
**
|
 Database accessible upon request 
[
here
](
here
)
. Surveys were conducted in April and July 2011. 
|
 Individual-level survey had a 35% response rate. Unknown differences between responders and non-responders. Not all agricultural laboratories perform public health functions. 
|
|
**
Council of State and Territorial Epidemiologists (CSTE) National Assessment of Epidemiology Capacity Data
**
|
 Conducted its seventh periodic Epidemiology Capacity Assessment (ECA) in 2021 during COVID-19. Periodic assessments since 2001 available 
[
here
](
https://www.cdc.gov/mmwr/volumes/71/wr/mm7113a2.htm
)
. 
|
 Workforce data in 2009 assessment relied on individual-level surveys with a 70% response rate. Survey limited to state health department epidemiologists. Local epidemiologists' enumeration derived from state estimates. 
|
|
**
...
**
|
 All data up to 2018 is publicly available 
[
here
](
here
)
. HRSA conducts NSSRN every 4 years, with the latest data from 2018. 
|
 Survey response rate of 62.4%. Data only includes RNs; does not capture licensed practical nurses or other non-RNs. 
|
|
**
Association of Schools of Public Health (ASPH) Annual Data Report
**
|
...
. 
|
 Data undercounts faculty. Program area categorizations lack consistency. Data does not report students entering the public health profession annually. Faculty data collection is infrequent and lacks detail. 
|
|
**
Public Health Foundation’s Training Finder Real-Time Affiliate Integrated Network (TRAIN)
**
|
 Lack of any publicly available or useful dataset. 23 states use TRAIN as their learning management system. 
|
 No information on changes in job titles across time. No geographic area data. Potential for incomplete data as many questions are optional. Limited representativeness due to voluntary participation. 
|
|
**
...
**
|
 ACPM presented data during a 2007 IOM testimony providing estimates of preventive medicine physicians in different settings. No latest publicly available data. 
|
 Limited information on survey methodology and analysis. Issues with overcounting and undercounting due to misspecification. Data limited to preventive medicine physicians only. 
|
