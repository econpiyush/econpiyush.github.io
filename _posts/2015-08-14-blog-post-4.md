...
|
 Data is not publicly available but available upon request. All profile study reports are publicly available. Nine profile studies conducted so far, with the most recent in 2019. 
|
...
|
 Classification based on job title, not public health function. Job classifications do not easily correspond to previous enumeration efforts. Accessing data is difficult as it is not publicly available. 
|
|
...
|
 Specific to a limited number of public health workers. NAICS needs 5-digit codes to identify government agencies. Data may lead to overcounting public health workers. 
|
|
